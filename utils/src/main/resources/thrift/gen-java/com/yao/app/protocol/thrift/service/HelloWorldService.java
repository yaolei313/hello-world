...
public class HelloWorldService {
  ...
  public interface AsyncIface {
    ...
    public void sayHelloWithException(String username, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String recv_sayHelloWithException() throws BusinessBasicException, org.apache.thrift.TException
    {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "sayHelloWithException failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sayHelloWithException_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String username;
      public sayHelloWithException_call(String username, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.username = username;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("sayHelloWithException", org.apache.thrift.protocol.TMessageType.CALL, 0));
        sayHelloWithException_args args = new sayHelloWithException_args();
        args.setUsername(username);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public String getResult() throws BusinessBasicException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_sayHelloWithException();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sayHelloWithException<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sayHelloWithException_args> {
      public sayHelloWithException() {
        super("sayHelloWithException");
      }

      public sayHelloWithException_args getEmptyArgsInstance() {
      ...
      public sayHelloWithException_result getResult(I iface, sayHelloWithException_args args) throws org.apache.thrift.TException {
        sayHelloWithException_result result = new sayHelloWithException_result();
        try {
          result.success = iface.sayHelloWithException(args.username);
        } catch (BusinessBasicException e) {
          result.e = e;
        }
        return result;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHelloWithException<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHelloWithException_args, String> {
      ...
      public AsyncMethodCallback<String> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        ...
        return new AsyncMethodCallback<String>() { 
          ...
          public void onError(Exception e) {
            ...
            org.apache.thrift.TBase msg;
            sayHelloWithException_result result = new sayHelloWithException_result();
            if (e instanceof BusinessBasicException) {
                        result.e = (BusinessBasicException) e;
      ...
      public void start(I iface, sayHelloWithException_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
  ...
  public static class sayHelloWithException_args implements org.apache.thrift.TBase<sayHelloWithException_args, sayHelloWithException_args._Fields>, java.io.Serializable, Cloneable, Comparable<sayHelloWithException_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("sayHelloWithException_args");

    private static final org.apache.thrift.protocol.TField USERNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("username", org.apache.thrift.protocol.TType.STRING, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new sayHelloWithException_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new sayHelloWithException_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.USERNAME, new org.apache.thrift.meta_data.FieldMetaData("username", org.apache.thrift.TFieldRequirementType.REQUIRED, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(sayHelloWithException_args.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public sayHelloWithException_args(sayHelloWithException_args other) {
      if (other.isSetUsername()) {
        this.username = other.username;
      }
    }

    public sayHelloWithException_args deepCopy() {
      return new sayHelloWithException_args(this);
    }
    ...
    public sayHelloWithException_args setUsername(String username) {
      this.username = username;
      return this;
    }
    ...
    public boolean equals(Object that) {
      ...
      if (that instanceof sayHelloWithException_args)
        return this.equals((sayHelloWithException_args)that);
      return false;
    }

    public boolean equals(sayHelloWithException_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(sayHelloWithException_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    private static class sayHelloWithException_argsStandardSchemeFactory implements SchemeFactory {
      public sayHelloWithException_argsStandardScheme getScheme() {
        return new sayHelloWithException_argsStandardScheme();
      }
    }

    private static class sayHelloWithException_argsStandardScheme extends StandardScheme<sayHelloWithException_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, sayHelloWithException_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sayHelloWithException_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class sayHelloWithException_argsTupleSchemeFactory implements SchemeFactory {
      public sayHelloWithException_argsTupleScheme getScheme() {
        return new sayHelloWithException_argsTupleScheme();
      }
    }

    private static class sayHelloWithException_argsTupleScheme extends TupleScheme<sayHelloWithException_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sayHelloWithException_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        oprot.writeString(struct.username);
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sayHelloWithException_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        struct.username = iprot.readString();
        struct.setUsernameIsSet(true);
      }
  ...
  public static class sayHelloWithException_result implements org.apache.thrift.TBase<sayHelloWithException_result, sayHelloWithException_result._Fields>, java.io.Serializable, Cloneable, Comparable<sayHelloWithException_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("sayHelloWithException_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new sayHelloWithException_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new sayHelloWithException_resultTupleSchemeFactory());
    }

    public String success; // required
    public BusinessBasicException e; // required
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(sayHelloWithException_result.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public sayHelloWithException_result(sayHelloWithException_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
      if (other.isSetE()) {
        this.e = new BusinessBasicException(other.e);
      }
    }

    public sayHelloWithException_result deepCopy() {
      return new sayHelloWithException_result(this);
    }
    ...
    public sayHelloWithException_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public BusinessBasicException getE() {
      return this.e;
    }

    public sayHelloWithException_result setE(BusinessBasicException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case E:
        if (value == null) {
          ...
          setE((BusinessBasicException)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      ...
      if (that instanceof sayHelloWithException_result)
        return this.equals((sayHelloWithException_result)that);
      return false;
    }

    public boolean equals(sayHelloWithException_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(sayHelloWithException_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    private static class sayHelloWithException_resultStandardSchemeFactory implements SchemeFactory {
      public sayHelloWithException_resultStandardScheme getScheme() {
        return new sayHelloWithException_resultStandardScheme();
      }
    }

    private static class sayHelloWithException_resultStandardScheme extends StandardScheme<sayHelloWithException_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, sayHelloWithException_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // E
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.e = new BusinessBasicException();
                struct.e.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sayHelloWithException_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class sayHelloWithException_resultTupleSchemeFactory implements SchemeFactory {
      public sayHelloWithException_resultTupleScheme getScheme() {
        return new sayHelloWithException_resultTupleScheme();
      }
    }

    private static class sayHelloWithException_resultTupleScheme extends TupleScheme<sayHelloWithException_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sayHelloWithException_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sayHelloWithException_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
