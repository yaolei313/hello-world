/*
 * Hello.java - MBean implementation for the Hello World MBean. This class must implement all the
 * Java methods declared in the HelloMBean interface, with the appropriate behavior for each one.
 */
...
public class Hello extends NotificationBroadcasterSupport implements HelloMBean {
    ...
    public synchronized void setCacheSize(int size) {
        ...
        /*
         * Construct a notification that describes the change. The "source" of a notification is the
         * ObjectName of the MBean that emitted it. But an MBean can put a reference to itself
         * ("this") in the source, and the MBean server will replace this with the ObjectName before
         * sending the notification on to its clients.
         * 
         * For good measure, we maintain a sequence number for each notification emitted by this
         * MBean.
         * 
         * The oldValue and newValue parameters to the constructor are of type Object, so we are
         * relying on Tiger's autoboxing here.
         */
        Notification n =
        ...
        /*
         * Now send the notification using the sendNotification method inherited from the parent
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        ...
        // 目前理解：70行会发出此通知，所以此方法中只描述了这一种通知
