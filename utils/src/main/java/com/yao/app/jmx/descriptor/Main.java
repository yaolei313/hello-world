/**
 * Main.java - main class for QueueSampler example. Create the Queue Sampler MXBean, register it,
 * then wait forever (or until the program is interrupted).
 */

package com.yao.app.jmx.descriptor;
