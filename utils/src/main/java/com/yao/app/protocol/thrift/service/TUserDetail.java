...
public class TUserDetail implements org.apache.thrift.TBase<TUserDetail, TUserDetail._Fields>, java.io.Serializable, Cloneable, Comparable<TUserDetail> {
  ...
  public int compareTo(TUserDetail other) {
    ...
    lastComparison = Boolean.valueOf(isSetSnsAccountNo()).compareTo(other.isSetSnsAccountNo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSnsAccountNo()) {
    ...
    lastComparison = Boolean.valueOf(isSetOtherProperties()).compareTo(other.isSetOtherProperties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOtherProperties()) {
    ...
    lastComparison = Boolean.valueOf(isSetLoginTimestamp()).compareTo(other.isSetLoginTimestamp());
    if (lastComparison != 0) {
      return lastComparison;
    }
