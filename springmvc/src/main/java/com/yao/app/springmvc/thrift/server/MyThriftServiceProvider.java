...
import com.yao.app.springmvc.thrift.service.UserService;
import com.yao.app.springmvc.thrift.service.impl.HelloWorldImpl;
import com.yao.app.springmvc.thrift.service.impl.UserServiceImpl;

public class MyThriftServiceProvider implements InitializingBean {
    
    private Logger logger = LoggerFactory.getLogger(MyThriftServiceProvider.class);
    ...
    public void afterPropertiesSet() throws Exception {
        try{
            ...
            this.provideService();
            logger.debug("thrift service startted");
        }catch(Exception e){
            logger.error("启动thrift服务失败", e);
        }
    ...
    public void provideService() throws TTransportException{
        ...
        processor.registerProcessor("HELLO_SERVICE", new HelloWorldService.Processor<HelloWorldService.Iface>(new HelloWorldImpl()));
        processor.registerProcessor("USER_SERVICE", new UserService.Processor<UserService.Iface>(new UserServiceImpl()));
